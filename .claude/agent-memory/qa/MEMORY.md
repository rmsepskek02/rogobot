...
## lostark-build.js GOLD_TABLE 검증 패턴 (2026-04-16)

- GOLD_TABLE 수치 변경 시 node -e 로 시뮬레이션하여 Plan.md 기대값 대조 필수
- buildCharacters 검증 시나리오:
  1. 단일 구간 6명 (골드 * 6 일치 확인)
  2. 귀속골드 0 구간 6명 (●귀속 줄 미출력 확인)
  3. 혼합 구간 6명 (비귀속/귀속 각각 정확한 합산 확인)
- 2026-04-16 gold-table-update: 3-tuple 변환 + 1750 구간 추가 + 귀속 분리 출력 — 전 항목 PASS
