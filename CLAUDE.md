...
- 주석은 한국어로 작성
- 로그는 `log/YYYY-MM-DD-hh:mm_작업명/log.md` 형식으로 작업별 폴더에 저장
...
## 작업 문서화 규칙
- 작업 시작 전 `docs/YYYY-MM-DD-hh:mm_작업명/Plan.md` 형식으로 폴더와 파일 생성
...
- 테스트 완료 후 `log/YYYY-MM-DD-hh:mm_작업명/log.md` 작성
